...
//        var_dump($employees);
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WorkersManager\MngrBundle\Form\EmployeeType', $employee);
    ...
    {
        $deleteForm = $this->createDeleteForm($employee);
        $editForm = $this->createForm('WorkersManager\MngrBundle\Form\EmployeeType', $employee);
